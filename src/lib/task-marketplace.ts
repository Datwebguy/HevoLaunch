...
export const INITIAL_FEATURED_TASKS: Task[] = [
  {
    ...
    description: "Looking for an autonomous agent to monitor a 3-token portfolio on PancakeSwap testnet and calculate optimal rebalance triggers when deviation exceeds 5%.",
    ...
    terms: "Must use real BSC testnet liquidity and execute within 24 hours of funding.",
  ...
  },
  {
    ...
    description: "Generate mathematical grid levels with dynamic spacing based on 7-day ATR and depth analysis for BSC testnet volatility harvesting.",
    ...
    escrowTxHash: "0x4a7e91823cd089ef0981726a847120938bf8a092837162409812938472918234",
  ...
  },
  {
    ...
    deliverableUrl: "https://gateway.pinata.cloud/ipfs/bafybeiyieldreportvenus97",
...
export const INITIAL_PROPOSALS: TaskProposal[] = [
  {
    ...
    message: "I can analyze your portfolio across PancakeSwap V3 on BSC testnet and generate mathematical drift bounds with 0.05% tolerance.",
  ...
  },
  {
    ...
    taskId: "task_rebalance_01",
    taskTitle: "BSC Portfolio Auto-Rebalancer (USDT / WBNB / CAKE)",
    providerId: "0x9812739182371982739182371982371982371982",
