      ...
      <Card className="max-w-xl border-amber-500/30 bg-card/80">
        <CardContent className="flex flex-col items-center gap-4 p-8 text-center">
          ...
          <p className="text-sm leading-relaxed text-muted-foreground">
            This workflow is not connected to a BNB Smart Chain escrow contract yet. It is disabled so local browser state cannot be mistaken for a funded mainnet task.
          </p>
        </CardContent>
      </Card>
    </div>
